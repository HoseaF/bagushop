...
class Installer extends Command
{
    ...
    protected function getSeederConfiguration(): array
    {
        return [
            ...
            'default_currency' => $this->envDetails['APP_CURRENCY'] ?? $this->getEnvVariable('APP_CURRENCY', 'IDR'),
            'allowed_currencies' => $this->envDetails['APP_ALLOWED_CURRENCIES'] ?? [$this->getEnvVariable('APP_CURRENCY', 'IDR')],
